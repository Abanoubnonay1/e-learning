...
//mongodb+srv://foo22:F6jNYJSn12UIsgtk@cluster0.dwqbsdt.mongodb.net/
//mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ts3db.mongodb.net/?retryWrites=true&w=majority
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.dwqbsdt.mongodb.net/`;
